...
export const HideIconBalance = (style) => (
...
export const hideIconPassword = (style) => (
  <Icon name="eye-outline" {...style} />
);
...
export const OoperationIcon = (style) => (
...
export const ExchangeIcon = (style) => (
